...
export default function AdminArticlePage() {
  ...
  function updateArticle() {
    axios
      .put(`${import.meta.env.VITE_BACKEND_URL}/articles/${params.id}`, {
        ...article,
  ...
  function deleteArticle() {
    // Je supprime cet article de la table article et les lignes relatives à cet article dans la table de jointure article_category
